...
$use_smtp = '0';
$emailto = 'admin@pericial-electricos.com';

	// retrieve from parameters
	$emailfrom = isset($_POST["email"]) ? $_POST["email"] : "";
	$nocomment = isset($_POST["nocomment"]) ? $_POST["nocomment"] : "";
	$subject = 'Email desde Pericial daños eléctricos';
	$message = '';
	$response = '';
	$response_fail = 'Hay un error, modifique los detalles.';
...
function sendEmail($subject, $content, $emailto, $emailfrom) {
	...
	$from = $emailfrom;
	$response_sent = 'Gracias. Su mensaje ha sido recibido.';
	$response_error = 'Error. Vuelva a intentarlo.';
